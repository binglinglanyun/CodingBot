//------------------------------------------------------------------------------
// <copyright file="CodingBotPackage.cs" company="Company">
...
namespace CodingBot
{
    ...
    {
        /// <summary>
        /// CodingBotPackage GUID string.
        /// </summary>
        public const string PackageGuidString = "638d2d72-dc60-49a8-a7bb-e90be3db0b6a";

        /// <summary>
        /// Initializes a new instance of the <see cref="CodingBot"/> class.
        /// </summary>
        public CodingBotPackage()
        {
